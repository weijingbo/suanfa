...
public class D3ReorderData {
    ...
    public String[] reorderLogFiles(String[] logs) {
        Arrays.sort(logs, (log1, log2) -> {//运用到了java里的泛型，第二个参数重新定义排序规则
            ...
            //compareto 返回-1大的在前，0不交换位置，1小的在前
        });
        return logs;
    }
    ...
    public static void main(String[] args) {
        ...
        D3ReorderData d3ReorderData = new D3ReorderData();
        System.out.println(Arrays.toString(d3ReorderData.reorderLogFiles(logs)));
    }
}
