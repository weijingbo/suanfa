...
public class D23ErectTheFence {
    ...
    public static void main(String[] args) {
        D23ErectTheFence d23ErectTheFence = new D23ErectTheFence();
        System.out.println(Arrays.toString(d23ErectTheFence.outerTrees(new int[][]{{1,1},{2,2},{2,0},{2,4},{3,3},{4,2}})));
    }
}
