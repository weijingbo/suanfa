...
public class NumberOfLines {
    ...
    public int[] numberOfLines(int[] widths, String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            if(ans[1]+widths[s.charAt(i)-97]>100){
                ans[0]+=1;
                ans[1] =0;
            }
            ans[1] = ans[1]+widths[s.charAt(i)-97];
        }
        return  ans;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(numberOfLines.numberOfLines(widths, "abcdefghijklmnopqrstuvwxyz")));
    }
}
